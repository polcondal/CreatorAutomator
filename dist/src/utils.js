...
class Utils {
    static async getBoolInput(question) {
        let answer = null;
    ...
    static async getNumberInput(question) {
        let answer = null;
        while (!Number(answer)) {
            answer = await rl.question(question);
        }
    ...
    static async getStringInput(question) {
        let answer = null;
        while (answer === null) {
            answer = await rl.question(question);
        }
    ...
    static ErrorInValues(accounts, prompt, collection) {
